...
`DEPLOY_PWA.md` et `QUICK_START_PWA.md` sont des guides de déploiement destinés à l'utilisateur (Netlify/Vercel/manuel). En cas de doute, faire confiance à l'arborescence réelle.
