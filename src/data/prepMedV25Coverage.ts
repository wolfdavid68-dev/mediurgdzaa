...
export const PREP_MED_V25_COVERAGE = {
  ...
  30: { id: 30, nom: "GLUCAGEN", strategies: ["steps"] },
  ...
  53: { id: 53, nom: "AUGMENTIN", strategies: ["steps", "phase_doses"] },
  54: {
    id: 54,
    nom: "AMOXICILLINE",
    strategies: ["steps", "dose_kg", "phase_doses", "dose_input", "amoxicilline_meningee_pump"],
  },
  55: {
    id: 55,
    nom: "ZOVIRAX",
  ...
  60: { id: 60, nom: "FLAGYL", strategies: ["steps", "phase_doses"] },
  61: { id: 61, nom: "TAZOCILLINE", strategies: ["steps", "phase_doses"] },
  62: { id: 62, nom: "ROVAMYCINE", strategies: ["steps", "phase_doses"] },
  63: { id: 63, nom: "VANCOMYCINE", strategies: ["steps", "dose_kg", "phase_doses"] },
