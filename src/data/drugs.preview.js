      ...
      preparations: [
        {
          ...
          rows: [
            ...
            { label: "Perfuser", value: "2-3h", highlight: true },
          ],
          hide_final: true,
          etapes: [
        ...
        },
        {
          ...
          phase_doses: [{ label: "Entretien", dose_kg: 15, dose_max_kg: 20, unit: "mg" }],
          hide_phase_volume: true,
          rows: [
            { label: "Rythme", value: "/8-12h (cible AUC)", highlight: true },
            { label: "500 mg", value: "→ 100 mL", highlight: true },
            { label: "1 g", value: "→ 250 mL (100 mL sur KTC)", highlight: true },
            { label: "Perfuser", value: "60 min minimum" },
          ],
          hide_final: true,
          etapes: [
            "Flacon poudre 500 mg ou 1 g",
