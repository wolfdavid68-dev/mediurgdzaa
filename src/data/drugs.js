...
export const DRUGS = [
  ...
  },
  {
    ...
    prep: {solvant:"NaCl 0,9%",volume_final:20,conc_finale:"1 mg/mL",conc_produit:10,unite:"mg",dose_kg:0.2,duree:"IVL sur 2-3 min, répéter /4-6h",stabilite:"24h à 25°C après dilution",etapes:["Ampoule 20 mg/2 mL (10 mg/mL)","Dilution : 1 ampoule 20 mg qsp 20 mL NaCl 0,9% → 1 mg/mL","Injecter 0,2 mg/kg IVL sur 2-3 min","Voie intrarectale possible chez l'enfant : 0,4 mg/kg (produit pur)"],notes:["NON stupéfiant (liste I) — pas de cahier des stups","Effet plafond : ne pas associer à un agoniste µ pur (antagonisme)","Antagoniste : Naloxone","Avantage pédiatrique : voie IR possible si pas de VVP"],pedTable:{titre:"Table de dilution pédiatrique — Nalbuphine 1 mg/mL",description:"1 ampoule 20 mg/2 mL diluée qsp 20 mL NaCl 0,9% → 1 mg/mL. Garder le volume calculé puis diluer jusqu'à 4 mL avec NaCl 0,9%.",bandes:[{kg_min:1,kg_max:40,mode:"dilute",preparation:"Solution mère 1 mg/mL (20 mg dans 20 mL NaCl 0,9%)",vol_per_kg:0.2,volume_final:4,solvant:"NaCl 0,9%"}]}},
  },
  {
    id: 8,
    nom: "NARCAN",
