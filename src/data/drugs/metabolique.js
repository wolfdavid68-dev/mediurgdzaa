...
export const DRUGS_METABOLIQUE = [
  ...
  },
  {
    ...
    poso: {
      a: ["Asthme/anaphylaxie : 1-2 mg/kg IV", "Voies : VVP ou VVC"],
      ...
      preparations: [
        ...
        },
        {
          ...
          rows: [
            ...
            { label: "Perfuser", value: "20-30 min" },
            { label: "Max", value: "40 mg/dose", highlight: true },
          ],
          etapes: [
            "Dose enfant : 1 mg/kg IV /12h, max 40 mg/dose",
            "Prélever uniquement la dose calculée après reconstitution",
  ...
  },
  {
    ...
    poso: {
      a: ["IVL : administrer PUR", "10 mg IV lente /8h", "Voies : VVP ou VVC"],
