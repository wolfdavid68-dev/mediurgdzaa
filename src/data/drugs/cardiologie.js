...
export const DRUGS_CARDIOLOGIE = [
  ...
  },
  {
    ...
    prep: {
      ...
      etapes: [
        ...
        "Administrer pur en bolus IV rapide 2-3 sec",
  ...
  },
  {
    ...
    prep: {
      ...
      stabilite: "24h à 25°C",
      etapes: [
        "Ampoule 25 mg/5 mL (5 mg/mL) — pur pour bolus",
        "PSE : 2 ampoules 25 mg/5 mL qsp 50 mL → 50 mg/50 mL → 1 mg/mL",
        "Bolus : administrer pur (5 mg/mL), 2,5-5 mL lentement",
      ],
      notes: ["Conserver l'ampoule dans son emballage à l'abri de la lumière"],
    },
  },
  {
    id: 81,
  ...
  },
  {
    ...
    prep: {
      ...
      dose_kg: 0.25,
      prelever_total: true,
      prelever_label: "1 flacon reconstitué",
      duree: "IVL en 2 min",
      etapes: [
        "Flacon 25 mg poudre",
