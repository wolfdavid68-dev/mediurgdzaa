...
export const DRUGS_NEUROLOGIE = [
  {
    ...
    cond: ["Ampoule 10 mg/2 mL (5 mg/mL)"],
    poso: {
      a: [
      ...
      p: [
        "IVD nourrisson : 0,5 mg/kg lente (max 10 mg)",
        "IVD enfant : 0,2-0,3 mg/kg lente (max 10 mg)",
        "Rectal nourrisson et enfant : 0,5 mg/kg (max 10 mg)",
      ],
    },
    prep: {
      ...
      preparations: [
        ...
        },
        {
          ...
          rate_value: "IM pur",
          hide_final: true,
          etapes: ["Ampoule 10 mg/2 mL (5 mg/mL)", "IM : administrer 10 mg pur"],
          notes: ["Risque d'apnée et de dépression respiratoire"],
        },
        {
          titre: "IVD nourrisson",
          mode: "bolus",
          population: "enfant",
          calculated_volume_role: "injecter",
        ...
        {
          titre: "Rectal nourrisson / enfant",
          mode: "bolus",
          population: "enfant",
