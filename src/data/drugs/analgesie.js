    ...
    prep: {
      ...
      preparations: [
        ...
        },
        {
          ...
          etapes: [
            "Ampoule 250 µg/5 mL (50 µg/mL) — utiliser pure",
            "Dose pleine IN : 0,3 µg/kg",
            "Demi-dose de rappel : 0,15 µg/kg",
            "Répartir par narine selon le volume calculé",
          ],
          notes: [
            "Si douleur persistante après 10 min : répéter une demi-dose toutes les 15 min jusqu'à antalgie ou VVP",
            "Délai d'action < 10 min ; durée 30 min à 1 h",
            "Stupéfiant : tracer dans le cahier — ne pas jeter les ampoules",
          ],
        },
      ],
