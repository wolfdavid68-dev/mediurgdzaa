  ...
  return (
    <div className={`drug-card ${open ? "drug-card-open" : ""}`}>
        ...
        <div className="drug-body">
          ...
          <div className="tabs-row">
            ...
            {!showKtcLines && (
              <Tab
                ...
                label={isRearmementKit ? "Réarmement" : "Matériel"}
              />
            )}
            {showChecklist && (
              <ChecklistTab
          ...
          <div className="tab-content">
            ...
            {activeTab === "schema" && kit.schema && (
              <SchemaView kit={kit} onZoom={() => setSchemaZoom(true)} />
            )}
      ...
      {schemaZoom && kit.schema && (
        <SchemaLightbox kit={kit} onClose={() => setSchemaZoom(false)} />
      )}
    </div>
  );
};
...
const Tab = ({
  ...
  >
    <span
      className={`dot ${kind === "tab-poso" ? "dot-poso" : kind === "tab-info" ? "dot-info" : kind === "tab-danger" ? "dot-danger" : "dot-neutral"}`}
      style={kind === "tab-poso" && color ? { background: color } : undefined}
    />
          ...
          <li key={i} className="checklist-item">
            <label className={`checklist-label ${checked ? "checklist-checked" : ""}`}>
              ...
              <span
                ...
                style={checked ? { background: kit.couleur, borderColor: kit.couleur } : {}}
                aria-hidden="true"
              >
                <CheckIcon />
              </span>
...
const SchemaLightbox = ({ kit, onClose }: { kit: PrepKit; onClose: () => void }) => {
  ...
  return (
    ...
    >
      <button type="button" className="kit-schema-lbclose" aria-label="Fermer" onClick={onClose}>
        <CloseIcon />
      </button>
